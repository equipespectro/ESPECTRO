...
| RF_B003.1     | Recuperar Senha | Desenvolvido| rotaapp.get('/recover') no arquivo index.js   |
| RF_B004     | Fazer Logout       |   Desenvolvido | rota app.get("/sessionLogout") no arquivo index.js   |
...
| RF_B005.2     | Remover Atividade       |   Desenvolvido | botão que remove tarefa pelo id no arquivo listaTarefas.ejs    |
